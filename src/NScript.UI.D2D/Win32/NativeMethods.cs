    ...
    internal static class NativeMethods
    {
        ...
        */
        ...
        public struct MSG
        {
            ...
            public bool IsWndDestoryMessage
            {
                get
                {
                    bool val = false;
        ...
        public static extern IntPtr IntCreateWindowEx(int dwExStyle, string lpszClassName,
                                                   ...
                                                   HandleRef hWndParent, HandleRef hMenu, HandleRef hInst, IntPtr lpParam);
        ...
        [DllImport(ExternDll.User32, CharSet = CharSet.Auto, SetLastError = true)]
        public static extern short RegisterClass(ref NativeMethods.WNDCLASS_D wc);
        ...
        //public static extern int RegisterDragDrop(HandleRef hwnd,  target);
        [DllImport(ExternDll.Ole32, ExactSpelling = true, CharSet = CharSet.Auto)]
