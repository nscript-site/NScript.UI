...
namespace NScript.UI.D2D
{
    ...
    /// </summary>
    public class D2DWriteResourceFontFileStream : CallbackBase, FontFileStream
    {
        private readonly DataStream _stream;

        /// <summary>
        /// Initializes a new instance of the <see cref="D2DWriteResourceFontFileStream"/> class.
        /// </summary>
        /// <param name="stream">The stream.</param>
        public D2DWriteResourceFontFileStream(DataStream stream)
        {
            _stream = stream;
        }
