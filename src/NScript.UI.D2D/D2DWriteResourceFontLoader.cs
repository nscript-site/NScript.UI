...
namespace NScript.UI.D2D
{
    ...
    internal class D2DWriteResourceFontLoader : CallbackBase, FontCollectionLoader, FontFileLoader
    {
        private readonly List<D2DWriteResourceFontFileStream> _fontStreams = new List<D2DWriteResourceFontFileStream>();
        private readonly List<D2DWriteResourceFontFileEnumerator> _enumerators = new List<D2DWriteResourceFontFileEnumerator>();
        private readonly DataStream _keyStream;

        /// <summary>
        /// Initializes a new instance of the <see cref="D2DWriteResourceFontLoader"/> class.
        /// </summary>
        /// <param name="factory">The factory.</param>
        /// <param name="fontAssets"></param>
        public D2DWriteResourceFontLoader(Factory factory, IEnumerable<Uri> fontAssets)
        {
        ...
        {
            var enumerator = new D2DWriteResourceFontFileEnumerator(factory, this, collectionKey);
